            ...
            ['libchromiumcontent_component', {
              'link_settings': {
                'libraries': [
                  ...
                  '<(libchromiumcontent_dir)/libnacl.a',
                  '<(libchromiumcontent_dir)/libnacl_browser.a',
                  '<(libchromiumcontent_dir)/libnacl_renderer.a',
                  '<(libchromiumcontent_dir)/libnacl_switches.a',
                  '<(libchromiumcontent_dir)/libnacl_common.a',
                  '<(libchromiumcontent_dir)/libnacl_trusted_plugin.a',
                  '<(libchromiumcontent_dir)/libnonnacl_srpc.a',
                  '<(libchromiumcontent_dir)/libdesc_wrapper.a',
                  '<(libchromiumcontent_dir)/libnrd_xfer.a',
                  '<(libchromiumcontent_dir)/libsel_ldr_launcher_base.a',
                  '<(libchromiumcontent_dir)/libsel.a',
                  '<(libchromiumcontent_dir)/libplatform_qual_lib.a',
                  '<(libchromiumcontent_dir)/libsimple_service.a',
                  '<(libchromiumcontent_dir)/libimc.a',
                  '<(libchromiumcontent_dir)/libnacl_base.a',
                  '<(libchromiumcontent_dir)/libplatform.a',
                  '<(libchromiumcontent_dir)/libnacl_error_code.a',
                  '<(libchromiumcontent_dir)/libdynamic_annotations.a',
                  '<(libchromiumcontent_dir)/libnacl_gio.a',
                  '<(libchromiumcontent_dir)/libbase_static.a',
                  '<(libchromiumcontent_dir)/libjsoncpp.a',
